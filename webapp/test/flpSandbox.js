		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aluno 01",
									"targetURL": "#AppFioriAluno01appfiorialuno01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFioriAluno01appfiorialuno01-display": {
								"semanticObject": "AppFioriAluno01appfiorialuno01",
								"action": "display",
								"description": "Aluno01 Fiori application.",
								"title": "Aluno 01",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFioriAluno01.appfiorialuno01",
									"url": sap.ui.require.toUrl("AppFioriAluno01/appfiorialuno01")
								}
							}
						}
					}
